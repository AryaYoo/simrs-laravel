...
namespace App\Livewire\Modul\RawatJalan\SubRawatJalan\ResepDokter;

use App\Models\RegPeriksa;
use App\Models\ResepObat;
use App\Repositories\RawatJalan\ResepDokterRepository;
...
class Index extends Component
{
    ...
    {
        return view('livewire.modul.rawat-jalan.sub-rawat-jalan.resep-dokter.index')
