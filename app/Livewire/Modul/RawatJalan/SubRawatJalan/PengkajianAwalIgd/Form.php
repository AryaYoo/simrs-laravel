...
class Form extends Component
{
    ...
    public function save(PengkajianAwalIgdRepository $repository)
    {
        ...
        try {
            ...
            return $this->redirectRoute('modul.rawat-jalan.sub-rawat-jalan.pengkajian-awal-keperawatan-igd', str_replace('/', '-', $this->noRawat), navigate: true);
        } catch (\Exception $e) {
    ...
    public function render()
    {
        ...
        return view('livewire.modul.rawat-jalan.sub-rawat-jalan.pengkajian-awal-igd.form', [
