...
namespace App\Livewire\Modul\RawatInap\SubRawatInap\ObservasiRanapPostpartum;

use Livewire\Component;
use App\Models\RegPeriksa;
use App\Livewire\Concerns\WithOptimisticLocking;
use App\Repositories\RawatInap\CatatanObservasiRanapPostpartumRepository;
...
class Index extends Component
{
    ...
    public $tfu, $kontraksi, $perdarahan, $keterangan;
    ...
    {
        $repo = new CatatanObservasiRanapPostpartumRepository();
    ...
    public function openModal()
    {
        $this->reset([
            ...
            'tfu', 'kontraksi', 'perdarahan', 'keterangan',
    ...
    public function edit(string $tglPerawatan, string $jamRawat)
    {
        ...
        if ($obs) {
            ...
            $this->perdarahan = $obs['perdarahan'];
    ...
    public function save(CatatanObservasiRanapPostpartumRepository $repository)
    {
        try {
            $this->validate([
                ...
                'tfu' => 'required|string|max:15',
                'kontraksi' => 'required|string|max:15',
                'perdarahan' => 'required|string|max:15',
                ...
                'spo2.max' => 'SpO2 maksimal 3 karakter.',
                ...
                'tfu.required' => 'TFU wajib diisi.',
                'tfu.max' => 'TFU maksimal 15 karakter.',
                'kontraksi.required' => 'Kontraksi wajib diisi.',
                'kontraksi.max' => 'Kontraksi maksimal 15 karakter.',
                'perdarahan.required' => 'Perdarahan wajib diisi.',
                'perdarahan.max' => 'Perdarahan maksimal 15 karakter.',
                'keterangan.required' => 'Keterangan wajib diisi.',
                'keterangan.max' => 'Keterangan maksimal 30 karakter.',
            ]);
            ...
            if ($this->isEditMode) {
                ...
                $msg = 'Observasi Rawat Inap Post Partum berhasil diperbarui.';
            } else {
                $repository->store($data);
                $msg = 'Observasi Rawat Inap Post Partum berhasil disimpan.';
            }
    ...
    public function delete(string $tglPerawatan, string $jamRawat, CatatanObservasiRanapPostpartumRepository $repository)
    {
        try {
            $repository->delete($this->noRawat, $tglPerawatan, $jamRawat);
            $this->loadObservasis();
            $this->dispatch('swal', ['title' => 'Terhapus!', 'text' => 'Observasi Rawat Inap Post Partum berhasil dihapus.', 'icon' => 'success']);
        } catch (\Exception $e) {
    ...
    public function render()
    {
        ...
        return view('livewire.modul.rawat-inap.sub-rawat-inap.observasi-ranap-postpartum.index', [
            'petugasList' => $petugasList,
        ])->layout('layouts.app', ['title' => 'Observasi Rawat Inap Post Partum']);
    }
}
