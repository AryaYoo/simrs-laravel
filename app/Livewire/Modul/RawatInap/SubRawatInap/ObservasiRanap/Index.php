...
namespace App\Livewire\Modul\RawatInap\SubRawatInap\ObservasiRanap;

use Livewire\Component;
use App\Models\RegPeriksa;
use App\Livewire\Concerns\WithOptimisticLocking;
use App\Repositories\RawatInap\CatatanObservasiRanapRepository;
...
class Index extends Component
{
    ...
    {
        $repo = new CatatanObservasiRanapRepository();
    ...
    public function save(CatatanObservasiRanapRepository $repository)
    {
        try {
            $this->validate([
            ...
            if ($this->isEditMode) {
                ...
                $msg = 'Observasi Rawat Inap berhasil diperbarui.';
            } else {
                $repository->store($data);
                $msg = 'Observasi Rawat Inap berhasil disimpan.';
            }
    ...
    public function delete(string $tglPerawatan, string $jamRawat, CatatanObservasiRanapRepository $repository)
    {
        try {
            $repository->delete($this->noRawat, $tglPerawatan, $jamRawat);
            $this->loadObservasis();
            $this->dispatch('swal', ['title' => 'Terhapus!', 'text' => 'Observasi Rawat Inap berhasil dihapus.', 'icon' => 'success']);
        } catch (\Exception $e) {
    ...
    public function render()
    {
        ...
        return view('livewire.modul.rawat-inap.sub-rawat-inap.observasi-ranap.index', [
            'petugasList' => $petugasList,
        ])->layout('layouts.app', ['title' => 'Observasi Rawat Inap']);
    }
}
