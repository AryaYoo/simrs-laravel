<div class="flex flex-col gap-6 pb-8">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-xl font-bold text-neutral-800 dark:text-neutral-100">Data Penyerahan Darah</h1>
        </div>
    </div>
    ...
    <div class="flex flex-col items-center justify-center py-24 gap-5">
        <div class="w-20 h-20 rounded-2xl flex items-center justify-center shadow-md"
            ...
            <flux:icon name="heart" class="w-10 h-10 text-white" />
        </div>
        <div class="text-center">
            ...
            <p class="text-sm text-neutral-400 dark:text-neutral-500 max-w-sm">
                Fitur <span class="font-semibold text-neutral-600 dark:text-neutral-300">Data Penyerahan Darah</span>
