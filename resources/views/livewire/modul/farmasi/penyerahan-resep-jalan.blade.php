                    ...
                    <table class="w-full text-xs">
                        <thead>
                            <tr class="bg-neutral-50 dark:bg-neutral-900/50">
                                ...
                                <th class="px-4 py-2.5 text-center font-semibold text-neutral-500 dark:text-neutral-400 w-16">Jml</th>
        ...
        >
            ...
            <div class="p-5 flex flex-col gap-5">
                ...
                <template x-if="errorMsg">
                    <div class="flex items-center gap-2 px-4 py-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-xs">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="relative rounded-xl overflow-hidden bg-neutral-100 dark:bg-neutral-900 aspect-video flex items-center justify-center border-2 border-dashed border-neutral-200 dark:border-neutral-700 transition-colors"
