<div class="flex flex-col gap-6 pb-8">
    ...
    <div class="flex flex-col gap-1">
        <div class="flex items-center gap-3">
            <a href="{{ route('modul.rawat-jalan.perawatan-tindakan', str_replace('/', '-', $regPeriksa->no_rawat)) }}" wire:navigate
            ...
            <div>
                <nav class="text-xs text-neutral-400 mb-0.5">
                    ...
                    <span>Observasi IGD</span>
                </nav>
                <h1 class="text-xl font-bold text-neutral-800 dark:text-neutral-100">Observasi IGD</h1>
            </div>
        </div>
    </div>
                    ...
                    <flux:table.row>
                        <flux:table.cell colspan="13">
                            <div class="flex flex-col items-center justify-center py-12 text-center">
                                ...
                                <h3 class="text-lg font-bold text-neutral-700 dark:text-neutral-300">Belum Ada Catatan Observasi IGD</h3>
                                <p class="text-neutral-500 mt-1 max-w-md">Belum ada catatan observasi yang ditambahkan untuk pasien ini.</p>
                            </div>
                        </flux:table.cell>
                    </flux:table.row>
                @endforelse
        ...
        <div x-show="open"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-neutral-800 dark:text-neutral-100">
                            {{ $isEditMode ? 'Edit Observasi IGD' : 'Input Observasi IGD' }}
                        </h3>
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-6 mb-6">
                    <flux:input wire:model="gcs" label="GCS (E,V,M)" placeholder="Contoh: 15" />
                    <flux:input wire:model="td" label="TD (mmHg)" placeholder="Contoh: 120/80" required />
                    <flux:input wire:model="hr" label="HR (x/menit)" placeholder="Contoh: 80" />
                    <flux:input wire:model="rr" label="RR (x/menit)" placeholder="Contoh: 20" />
                    <flux:input wire:model="suhu" label="Suhu (°C)" placeholder="Contoh: 36.5" />
                    <flux:input wire:model="spo2" label="SpO2 (%)" placeholder="Contoh: 98" required />
                </div>
