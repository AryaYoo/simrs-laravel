    ...
    <div class="flex flex-col gap-1">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <h1 class="text-xl font-bold text-neutral-800 dark:text-neutral-100">Catatan Keperawatan Rawat Jalan</h1>
            </div>
        </div>
    </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <div class="flex items-center gap-1.5 mt-2">
                                <flux:checkbox wire:model="autoTime" id="autoTime" />
                                <label for="autoTime" class="text-xs font-medium text-neutral-600 dark:text-neutral-400 cursor-pointer">Waktu Otomatis</label>
                            </div>
                        </div>
