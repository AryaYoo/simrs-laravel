<div class="flex flex-col gap-6 pb-8" x-data="{
        ...
        activePatient: { 
            noRawat: '{{ $no_rawat }}', 
            noRawatSlug: '{{ str_replace('/', '-', $no_rawat) }}',
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            <a href="{{ route('modul.rawat-jalan.index') }}" wire:navigate class="flex items-center justify-center w-10 h-8 rounded-md bg-[#4C5C2D] transition-colors hover:bg-[#3d4b24] shadow-sm">
                ...
                <div
                    ...
                    <div class="flex flex-col gap-1 text-white">
                        ...
                        <div class="flex items-center gap-2 mt-1 text-xs opacity-90">
                            <span class="bg-white/20 px-2 py-0.5 rounded font-mono">{{ $no_rawat }}</span>
                            <span class="opacity-50">•</span>
                            <span class="font-semibold uppercase tracking-wide">{{ $regPeriksa->pasien->nm_pasien ?? '' }}</span>
                        </div>
                    </div>
