<div class="animate-in fade-in duration-300">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-3">
            <span class="text-xs text-neutral-400 bg-neutral-100 dark:bg-neutral-700 px-2 py-1 rounded-full">{{ $this->allTindakan->count() }} catatan</span>
    ...
    <flux:table>
        ...
        <flux:table.rows>
            @forelse ($this->allTindakan as $item)
