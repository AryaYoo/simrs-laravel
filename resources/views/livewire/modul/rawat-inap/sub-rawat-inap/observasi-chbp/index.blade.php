        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <nav class="text-xs text-neutral-400 mb-0.5">
                    ...
                    <span>Observasi CHBP</span>
                </nav>
                <h1 class="text-xl font-bold text-neutral-800 dark:text-neutral-100">Observasi CHBP (Catatan Harian Bayi & Partus)</h1>
            </div>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <flux:table class="whitespace-nowrap mt-2">
                <flux:table.columns>
                    ...
                    <flux:table.column>Nadi</flux:table.column>
                    <flux:table.column>Suhu Rectal</flux:table.column>
                    <flux:table.column>DJJ</flux:table.column>
                    <flux:table.column>HIS</flux:table.column>
                    <flux:table.column>PPV</flux:table.column>
                        ...
                        <flux:table.row>
                            <flux:table.cell colspan="14">
                                <div class="flex flex-col items-center justify-center py-12 text-center">
                                    ...
                                    <p class="text-neutral-500 mt-1 max-w-md">Belum ada catatan observasi CHBP yang ditambahkan untuk pasien ini.</p>
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @endforelse
    ...
    <div x-data="{ 
        ...
        <div x-show="open"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-neutral-800 dark:text-neutral-100">
                            {{ $isEditMode ? 'Edit Observasi CHBP' : 'Input Observasi CHBP' }}
                        </h3>
                        <p class="text-xs text-neutral-500">Lengkapi data catatan harian bayi & partus pasien.</p>
                    </div>
                </div>
            ...
            <div class="p-8">
                    ...
                    <div class="md:col-span-3">
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <div class="flex items-center gap-1.5 mt-2">
                                <flux:checkbox wire:model="autoTime" id="autoTimeObsCHBP" />
                                <label for="autoTimeObsCHBP" class="text-xs font-medium text-neutral-600 dark:text-neutral-400 cursor-pointer">Waktu Otomatis</label>
                            </div>
                        </div>
                ...
                {{-- Vital Signs & CHBP fields --}}
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <flux:input wire:model="td" label="TD (mmHg) *" placeholder="Ex: 120/80" required />
                    <flux:input wire:model="hr" label="Nadi (x/m)" placeholder="Ex: 80" />
                    <flux:input wire:model="suhu" label="Suhu Rectal (°C)" placeholder="Ex: 36.5" />
                    <flux:input wire:model="djj" label="DJJ *" placeholder="Ex: 140" required />
                </div>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <flux:input wire:model="his" label="HIS *" placeholder="Ex: -" required />
                    <flux:input wire:model="ppv" label="PPV *" placeholder="Ex: -" required />
                    <flux:input wire:model="keterangan" label="Keterangan *" placeholder="Ex: -" required />
                </div>
            </div>
