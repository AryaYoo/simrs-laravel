        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <nav class="text-xs text-neutral-400 mb-0.5">
                    ...
                    <span>Observasi Rawat Inap Kebidanan</span>
                </nav>
                <h1 class="text-xl font-bold text-neutral-800 dark:text-neutral-100">Observasi Rawat Inap Kebidanan</h1>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 shadow-sm overflow-hidden flex flex-col mt-2 relative p-4">
        <div class="flex items-center justify-between mb-4 px-2">
            <h3 class="text-sm font-bold text-neutral-700 dark:text-neutral-300 uppercase tracking-wider flex items-center gap-2">
                ...
                Daftar Observasi Rawat Inap Kebidanan
            </h3>
        ...
        <div class="overflow-x-auto">
            <flux:table class="whitespace-nowrap mt-2">
                <flux:table.columns>
                    ...
                    <flux:table.column>BJJ</flux:table.column>
                    <flux:table.column>PPV</flux:table.column>
                    <flux:table.column>VT</flux:table.column>
                        ...
                        <flux:table.row>
                            <flux:table.cell colspan="17">
                                <div class="flex flex-col items-center justify-center py-12 text-center">
                                    ...
                                    <p class="text-neutral-500 mt-1 max-w-md">Belum ada catatan observasi rawat inap kebidanan yang ditambahkan untuk pasien ini.</p>
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @endforelse
        ...
        <div x-show="open"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-neutral-800 dark:text-neutral-100">
                            {{ $isEditMode ? 'Edit Observasi Rawat Inap Kebidanan' : 'Input Observasi Rawat Inap Kebidanan' }}
                        </h3>
                        <p class="text-xs text-neutral-500">Lengkapi data tanda-tanda vital & kebidanan pasien.</p>
                    </div>
                </div>
            ...
            <div class="p-8">
                    ...
                    <div class="md:col-span-3">
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <div class="flex items-center gap-1.5 mt-2">
                                <flux:checkbox wire:model="autoTime" id="autoTimeObsKebidanan" />
                                <label for="autoTimeObsKebidanan" class="text-xs font-medium text-neutral-600 dark:text-neutral-400 cursor-pointer">Waktu Otomatis</label>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <flux:input wire:model="bjj" label="BJJ *" placeholder="Ex: 140" required />
                    <flux:input wire:model="ppv" label="PPV *" placeholder="Ex: -" required />
                    <flux:input wire:model="vt" label="VT *" placeholder="Ex: -" required />
                </div>
            </div>
