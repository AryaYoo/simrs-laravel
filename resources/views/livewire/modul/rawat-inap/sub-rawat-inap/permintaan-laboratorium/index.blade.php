<div>
    ...
    <div class="flex items-center gap-1 mb-6 border-b border-neutral-200 dark:border-neutral-700">
        ...
        <button wire:click="$set('kategori', 'HASIL')" class="px-6 py-3 text-sm font-bold transition-all border-b-2 {{ $kategori === 'HASIL' ? 'border-[#4C5C2D] text-[#4C5C2D]' : 'border-transparent text-neutral-400 hover:text-neutral-600' }}">Hasil</button>
    </div>
                ...
                <details class="group bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 overflow-hidden [&_summary::-webkit-details-marker]:hidden">
                    ...
                    <summary class="list-none p-4 border-b border-neutral-100 dark:border-neutral-700 bg-[#4C5C2D]/5 flex items-center justify-between gap-4 cursor-pointer hover:bg-[#4C5C2D]/10 transition-colors">
                        ...
                        <div class="flex items-center gap-3 text-neutral-400">
                            <a href="{{ route('modul.rawat-inap.hasil-lab.cetak', ['no_rawat' => str_replace('/', '-', $no_rawat), 'tgl_periksa' => $hasil['tgl_periksa'], 'jam' => $hasil['jam']]) }}" 
                               target="_blank"
