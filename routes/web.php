...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('modul/rawat-inap/kelahiran-bayi/settings', \App\Livewire\Modul\RawatInap\KelahiranBayi\SklSettings::class)->name('modul.rawat-inap.kelahiran-bayi.settings');
    ...
    Route::get('modul/rawat-inap/permintaan-ranap', \App\Livewire\Modul\RawatInap\PermintaanRanap\Index::class)->name('modul.rawat-inap.permintaan-ranap');
    ...
    Route::get('modul/rawat-inap/{no_rawat}/catatan-sbar', \App\Livewire\Modul\RawatInap\SubRawatInap\CatatanSbar\Index::class)->name('modul.rawat-inap.sub-rawat-inap.catatan-sbar')->where('no_rawat', '.*');
    ...
    Route::get('modul/rawat-jalan/{no_rawat}/permintaan-rawat-inap', \App\Livewire\Modul\RawatJalan\SubRawatJalan\PermintaanRawatInap\Index::class)->name('modul.rawat-jalan.sub-rawat-jalan.permintaan-rawat-inap')->where('no_rawat', '.*');
    ...
    Route::get('modul/rawat-jalan/{no_rawat}/resume', \App\Livewire\Modul\RawatJalan\SubRawatJalan\ResumePasien\Index::class)->name('modul.rawat-jalan.sub-rawat-jalan.resume')->where('no_rawat', '.*');
    Route::get('modul/rawat-jalan/{no_rawat}/resume/detail', \App\Livewire\Modul\RawatJalan\SubRawatJalan\ResumePasien\Detail::class)->name('modul.rawat-jalan.sub-rawat-jalan.resume-detail')->where('no_rawat', '.*');
    Route::get('modul/rawat-jalan/{no_rawat}/resume/form', \App\Livewire\Modul\RawatJalan\SubRawatJalan\ResumePasien\Form::class)->name('modul.rawat-jalan.sub-rawat-jalan.resume-form')->where('no_rawat', '.*');
    ...
    Route::get('modul/rawat-jalan/{no_rawat}/hasil-usg-kandungan', \App\Livewire\Modul\RawatJalan\SubRawatJalan\HasilUsgKandungan\Index::class)->name('modul.rawat-jalan.sub-rawat-jalan.hasil-usg-kandungan')->where('no_rawat', '.*');
    Route::get('modul/rawat-jalan/{no_rawat}/icare', \App\Livewire\Modul\RawatJalan\Icare\Index::class)->name('modul.rawat-jalan.icare')->where('no_rawat', '.*');
    ...
    Route::get('modul/farmasi/penyerahan-resep-jalan/{no_resep?}', \App\Livewire\Modul\Farmasi\PenyerahanResepJalan::class)->name('modul.farmasi.penyerahan-resep-jalan')->where('no_resep', '.*');
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        Route::get('admin/sql-tracker/settings', \App\Livewire\Admin\SqlTrackerSettings::class)->name('admin.sql-tracker.settings');
